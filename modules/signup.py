from PySide6.QtWidgets import QWidget, QLabel, QLineEdit, QPushButton, QVBoxLayout, QGridLayout, QHBoxLayout, QMessageBox
...
class SignUpWindow(QWidget):
    ...
    def create_account(self):
        ...
        if not (first_name and last_name and email and role and password):
        ...
        try:
            ...
            # Show a QLabel indicating redirection
            ...
            # Use QTimer to delay the redirection
            QTimer.singleShot(2000, self.redirect_to_login)  # Redirect after 2 seconds
