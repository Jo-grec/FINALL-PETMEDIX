...
class PetMedix(QWidget):
    def __init__(self, user_id, role, last_name, first_name):
        ...
        user_layout.addSpacing(5)  # Add 10 pixels of space between username and user icon
        ...
        try:
            ...
            if hasattr(self, 'selected_pet_name'):
                ...
                if result:
                    ...
                    pet_widgets["WEIGHT"].setText(str(result[6]))
                    pet_widgets["HEIGHT"].setText(str(result[7]))
                    ...
                    db.cursor.execute("""
                        SELECT 
                            ...
                            CASE
                                ...
                                WHEN type = 'Other Treatment' THEN CONCAT('Type: ', treatment_type, '\nMedication: ', medication, '\nDosage: ', dosage)
                            END as remarks,
                            CASE
                        ...
                        FROM (
                            ...
                            WHERE pet_id = (SELECT pet_id FROM pets WHERE name = ?)
                            UNION ALL
                            SELECT date, 'Other Treatment' as type, veterinarian, NULL as diagnosis, NULL as prescribed_treatment, NULL as medication, dosage, NULL as vaccine, NULL as surgery_type, NULL as anesthesia, NULL as services, NULL as notes, treatment_type, NULL as next_scheduled, NULL as next_followup
