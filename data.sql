...
INSERT INTO `appointments` (`appointment_id`, `pet_id`, `client_id`, `date`, `status`, `payment_status`, `reason`, `veterinarian`) VALUES
(1, 4, 2, '2025-05-08', 'Scheduled', 'Paid', 'dawda', 'Axel'),
(2, 3, 2, '2025-05-14', 'No-Show', 'Unpaid', 'dawda', 'Axel');
...
INSERT INTO `pets` (`pet_id`, `client_id`, `name`, `gender`, `species`, `breed`, `color`, `birthdate`, `age`, `weight`, `height`, `blood_type`, `photo_path`) VALUES
(3, 2, 'Jano', 'Male', 'Cat', 'Catpin', 'dad', '2025-05-14', 3, 2.00, 2.00, 'B+', 'C:/Users/Joelmar/Pictures/cam/DSC00183.JPG'),
(4, 2, 'Alex', 'Male', 'Cat', 'Catpin', 'BW', '2025-05-14', 3, 20.00, 20.00, NULL, 'C:/Users/Joelmar/Pictures/cam/DSC00254.JPG'),
(5, 3, 'dwada', 'Male', 'dawd', 'dawd', 'bw', '2025-05-14', 3, 20.00, 20.00, NULL, 'C:/Users/Joelmar/Pictures/cam/DSC00257.JPG');
